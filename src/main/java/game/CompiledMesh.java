...
public class CompiledMesh extends AbstractGLResource implements ModelResource  {
	...
	private FloatBuffer getTexCoordData() {
		...
		FloatBuffer buf = BufferUtils.createFloatBuffer(numVertices*2*texCoordList.size());
