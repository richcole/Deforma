...
public class Main {
	...
	public static void main(String[] args) {
		...
		Mesh mesh = new MeshFactory().newSquareMeshOld(view.getUp().times(-5),
		...
		*/
		...
		erfReaderList.addComponent(new File(nwnRoot, "texturepacks/Textures_Tpa.erf"));
		erfReaderList.addComponent(new File(nwnRoot, "texturepacks/xp1_tex_tpa.erf"));
		erfReaderList.addComponent(new File(nwnRoot, "texturepacks/xp2_tex_tpa.erf"));
		...
		*/
		...
		view.addComponent(terrainBlockArray);
		*/
