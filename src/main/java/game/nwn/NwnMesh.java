...
public class NwnMesh {
  ...
  static private Logger logger = LoggerFactory.getLogger(NwnMesh.class);
  ...
  public AnimMesh getAnimMesh() {
    ...
    double alpha = 0.0;
    AnimMeshPlaneCollector planeCollector = new AnimMeshPlaneCollector(animMesh, null);
    ...
    for(MdlAnimation anim: mdl.getAnimMap().values()) {
      ...
      planeCollector = new AnimMeshPlaneCollector(animMesh, animName);
