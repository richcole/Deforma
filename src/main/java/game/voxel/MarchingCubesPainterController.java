...
public class MarchingCubesPainterController implements Simulant, InputController {
	...
	public void updateModel() {
		...
		CompiledMesh cubesMesh = new CompiledMesh(simpleProgram, mesh);
	...
	private void setLineMesh(Box box) {
		LineGeom line = new LineGeom(box, 0.1);
		CompiledMesh lineModel = new CompiledMesh(simpleProgram, new Mesh(material, line));
